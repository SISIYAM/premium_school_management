...
<html lang="en">
  ...
  <head>
    <title>Online Courses | Able Pro Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    <link
      rel="stylesheet"
      href="../assets/css/plugins/datepicker-bs5.min.css"
    />
          ...
          <ul class="pc-navbar">
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                ...
                <li class="pc-item">
                  <a class="pc-link" href="../dashboard/finance.html"
                    >Finance</a
                  >
                </li>
              </ul>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link">
                ...
                <span class="pc-mtext">Price</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
              <ul class="pc-submenu">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center">
                  <span
                    class="badge bg-light-success rounded-pill f-12 py-2 px-3"
                    >+10%</span
                  >
                    ...
                    <div class="col-4">
                      <div class="text-center d-inline-block px-md-3">
                        ...
                        <h5 class="d-inline-flex align-items-center gap-1 mb-0">
                          $20k
                          <i class="ti ti-arrow-narrow-down text-danger"></i>
                        </h5>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="text-center d-inline-block px-md-3">
                        ...
                        <h5 class="d-inline-flex align-items-center gap-1 mb-0">
                          $16k
                          <i class="ti ti-arrow-narrow-up text-success"></i>
                        </h5>
                      </div>
                    </div>
                    <div class="col-4">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img
                          src="../assets/images/admin/img-bootstrap.svg"
                          alt="img"
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img
                          src="../assets/images/admin/img-php.svg"
                          alt="img"
                          class="wid-40 rounded"
                        />
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img
                          src="../assets/images/admin/img-ux.svg"
                          alt="img"
                          class="wid-40 rounded"
                        />
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img
                          src="../assets/images/admin/img-web.svg"
                          alt="img"
                          class="wid-40 rounded"
                        />
                      </div>
          ...
          <div class="col-lg-7 col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <p
                  class="d-inline-flex align-items-center text-success gap-1 mb-0"
                >
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img
                          src="../assets/images/admin/img-c.svg"
                          alt="img"
                          class="wid-40 rounded"
                        />
                      </div>
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              ...
              <div class="theme-main-layout d-flex align-center gap-1 w-100">
                ...
                >
                  <img
                    src="../assets/images/customizer/compact.svg"
                    alt="img"
                    class="img-fluid"
                  />
                </a>
                ...
                >
                  <img
                    src="../assets/images/customizer/tab.svg"
                    alt="img"
                    class="img-fluid"
                  />
                </a>
              ...
              <div class="row theme-color theme-nav-caption">
                ...
                <div class="col-6">
                  <div class="d-grid">
                    ...
                    >
                      <img
                        src="../assets/images/customizer/caption-off.svg"
                        alt="img"
                        class="img-fluid"
                      />
                    </button>
                ...
                <div class="row theme-color theme-direction">
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="../assets/images/customizer/ltr.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
                  ...
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="../assets/images/customizer/rtl.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
                ...
                <div class="row theme-color theme-container">
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="../assets/images/customizer/full.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
                  ...
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="../assets/images/customizer/fixed.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
