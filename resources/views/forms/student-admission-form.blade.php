...
@section('form-body')
    <form action="{{ route('execute.student.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('roll_no') is-invalid @enderror" id="roll_no"
                        name="roll_no" value="{{ old('roll_no') }}" placeholder="Enter Roll Number" />
                    @error('roll_no')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <select id="category" class="form-select @error('category') is-invalid @enderror" name="category">
                        ...
                        <option value="physically_challenged"
                            {{ old('category') == 'physically_challenged' ? 'selected' : '' }}>Physically Challenged
                        </option>
                    </select>
                    @error('category')
                        <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('weight') is-invalid @enderror" id="weight"
                        name="weight" placeholder="Enter weight" value="{{ old('weight') }}" />
                    @error('weight')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('measurement_date') is-invalid @enderror"
                        id="measurement_date" name="measurement_date" value="{{ old('measurement_date') }}" />
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="tel" id="father_phone" name="father_phone"
                                ...
                                placeholder="Enter father's phone" value="{{ old('father_phone') }}" />
                            @error('father_phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="tel" id="mother_phone" name="mother_phone"
                                ...
                                placeholder="Enter mother's phone" value="{{ old('mother_phone') }}" />
                            @error('mother_phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select id="guardian_is" name="guardian_is"
                                ...
                                <option value="father" {{ old('guardian_is') == 'father' ? 'selected' : '' }}>Father
                                </option>
                                <option value="mother" {{ old('guardian_is') == 'mother' ? 'selected' : '' }}>Mother
                                </option>
                                <option value="other" {{ old('guardian_is') == 'other' ? 'selected' : '' }}>Other
                                </option>
                            </select>
                            @error('guardian_is')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="guardian_name" name="guardian_name"
                                ...
                                placeholder="Enter guardian's name" value="{{ old('guardian_name') }}" />
                            @error('guardian_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="guardian_relation" name="guardian_relation"
                                ...
                                placeholder="Enter relation with guardian" value="{{ old('guardian_relation') }}" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="tel" id="guardian_phone" name="guardian_phone"
                                ...
                                placeholder="Enter guardian's phone" value="{{ old('guardian_phone') }}" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="guardian_occupation" name="guardian_occupation"
                                ...
                                placeholder="Enter guardian's occupation" value="{{ old('guardian_occupation') }}" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" id="guardian_email" name="guardian_email"
                                ...
                                placeholder="Enter guardian's email" value="{{ old('guardian_email') }}" />
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea id="guardian_address" name="guardian_address"
                                ...
                                placeholder="Enter guardian's address">{{ old('guardian_address') }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="guardian_address_is_current">If Guardian Address Is
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="permanent_is_current">If Permanent Address Is Current
                                    Address</label>
                            </div>
                        </div>
                    </div>
