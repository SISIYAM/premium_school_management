                ...
                <div class="card-body px-0 py-2">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/admin/img-bootstrap.svg') }}" alt="img"
                        ...
                        <li class="list-group-item">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/admin/img-php.svg') }}" alt="img"
                                        class="wid-40 rounded" />
                                </div>
                        ...
                        <li class="list-group-item">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/admin/img-ux.svg') }}" alt="img"
                                        class="wid-40 rounded" />
                                </div>
                        ...
                        <li class="list-group-item">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/admin/img-web.svg') }}" alt="img"
                                        class="wid-40 rounded" />
                                </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/user/avatar-2.jpg') }}" alt="img"
                        ...
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/user/avatar-3.jpg') }}" alt="img"
                                        class="wid-40 rounded-circle" />
                                </div>
                        ...
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/user/avatar-4.jpg') }}" alt="img"
                                        class="wid-40 rounded-circle" />
                                </div>
                ...
                <div class="card-body px-0 py-2">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/admin/img-c.svg') }}" alt="img"
                                        class="wid-40 rounded" />
                                </div>
